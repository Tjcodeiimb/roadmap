...
export function SetPasswordForm() {
  ...
  return (
    <form
      ...
      className="flex flex-col gap-2 rounded-md border-2 border-ink bg-paper p-4"
    >
      <label className="text-sm font-bold text-ink">Set a password</label>
      ...
      <input
        ...
        className="rounded-md border-2 border-ink bg-paper-2 px-3 py-2 text-sm font-medium outline-none"
      />
